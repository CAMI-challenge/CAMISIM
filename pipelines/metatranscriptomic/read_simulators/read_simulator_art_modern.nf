...
process simulate_reads_art {
    ...
    conda 'bioconda::art_modern bioconda::gffutils bioconda::bedtools bioconda::pyfaidx'
    ...
    gzip -c sample${sample_id}_${genome_id}_1.fq > sample${sample_id}_${genome_id}_1.fq.gz
    gzip -c sample${sample_id}_${genome_id}_2.fq > sample${sample_id}_${genome_id}_2.fq.gz
