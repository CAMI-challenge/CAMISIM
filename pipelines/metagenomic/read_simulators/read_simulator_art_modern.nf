...
workflow read_simulator_art_modern {
    ...
    take: read_length_ch
    main:
        simulate_reads_art_modern(genome_location_distribution_ch, read_length_ch)
    emit:
        simulate_reads_art_modern.out[0]
        simulate_reads_art_modern.out[1].groupTuple()
}
...
process simulate_reads_art_modern {
    ...
    **/
    ...
    """
    art_modern --mode wgs --i-file ${fasta_file} --read_len ${read_length_ch} \
        ...
        --o-fastq sample${sample_id}_${genome_id}.fq \
